...
import edu.technopolis.advanced.cashSaver.response.Subscription;

/*
 * This Java source file was generated by the Gradle 'init' task.
 */
public class CashSaver {
    private static final Logger log = LoggerFactory.getLogger(CashSaver.class);

    public static void main(String[] args) {
        Properties props = new Properties();
        log.info("Reading application properties...");
        try {
            props.load(CashSaver.class.getResourceAsStream("/application.properties"));
        } catch (IOException e) {
